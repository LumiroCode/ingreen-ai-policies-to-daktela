...
$openInAttachmentSourceUrl = is_array($previewAttachment) && isset($previewAttachment['previewUrl']) && is_string($previewAttachment['previewUrl'])
        ...
        <div class="app-layout">
            ...
            <aside class="panel pdf-preview-panel" aria-labelledby="pdf-preview-heading">
                <div class="section-heading">
                    ...
                    <?php if ($openInAttachmentSourceUrl !== null): ?>
                        <a
                            class="button secondary pdf-open-in-source"
                            href="<?= htmlspecialchars($openInAttachmentSourceUrl, ENT_QUOTES, 'UTF-8') ?>"
                            target="_blank"
                            rel="noopener"
