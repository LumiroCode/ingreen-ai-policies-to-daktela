...
final class PolicyDataResponseParser
{
    ...
    private const KEY_ALIASES = [
        ...
        'numer rejestracyjny' => 'nr_rejestracyjny',
        'numer rejestracyjny pojazdu' => 'nr_rejestracyjny',
        ...
        'wspolposiadacz' => 'wspolposiadacz',
        'współposiadacz' => 'wspolposiadacz',
        'wspolwlasciciel' => 'wspolposiadacz',
        'współwłaściciel' => 'wspolposiadacz',
        'imie wspolposiadacza' => 'imie_wspolposiadacza',
        'imię współposiadacza' => 'imie_wspolposiadacza',
        'imie_wspolposiadacza' => 'imie_wspolposiadacza',
        'nazwisko wspolposiadacza' => 'nazwisko_wspolposiadacza',
        'nazwisko współposiadacza' => 'nazwisko_wspolposiadacza',
        'nazwisko_wspolposiadacza' => 'nazwisko_wspolposiadacza',
        'pesel wspolposiadacza' => 'pesel_wspolposiadacza',
        'pesel współposiadacza' => 'pesel_wspolposiadacza',
        'pesel_wspolposiadacza' => 'pesel_wspolposiadacza',
        'adres wspolposiadacza' => 'adres_wspolposiadacza',
        'adres współposiadacza' => 'adres_wspolposiadacza',
        'adres_wspolposiadacza' => 'adres_wspolposiadacza',
        ...
        'cena pakietu za pierwszy rok' => 'cena_pakietu',
        'cena_pakietu' => 'cena_pakietu',
        'cena wznowienia' => 'cena_wznowienia',
        'cena_wznowienia' => 'cena_wznowienia',
        'pc cena' => 'pc_cena',
        'pc_cena' => 'pc_cena',
        'ac cena' => 'ac_cena',
        'ac_cena' => 'ac_cena',
        ...
        'cena_nnw' => 'cena_nnw',
        'nnw cena' => 'cena_nnw',
        'cena assistance' => 'cena_assistance',
        'cena_assistance' => 'cena_assistance',
        'assistance cena' => 'cena_assistance',
        'gap cena' => 'gap_cena',
        'gap_cena' => 'gap_cena',
        'cena gap' => 'gap_cena',
        ...
        'data sprzedazy wznowienia' => 'data_sprzedazy_wznowienia',
        'data sprzedaży wznowienia' => 'data_sprzedazy_wznowienia',
        'data_sprzedazy_wznowienia' => 'data_sprzedazy_wznowienia',
        'car_make' => 'marka',
        'car_model' => 'model',
